...
//gt_shanhai模组配方批处理
    let myRecipes = [
        // ===== ULV 级 (EUt: ulv) =====
        { id: 'zero_point_conversion_energy', type: 'zero_point_conversion', notConsumable: ['gtceu:lv_electric_pump', 'gtlcore:primitive_fluid_regulator'], inputFluids: ['minecraft:water 3000'], outputFluids: ['dishanhai:zero_point_energy 500'], EUt: ulv, duration: 20 },
        ...
        { id: 'primordial_myriad_ascension_tier_2', type: 'primordial_myriad_ascension_tier_2',circuit:2, itemInputs: ['kubejs:quantum_chromodynamic_charge','4x kubejs:leptonic_charge','2x kubejs:quantumchromodynamic_protective_plating'], inputFluids: ['gtceu:miracle_gas 20','gtceu:liquid_starlight 30','gtceu:uu_matter 20'],EUt:uxv, duration: 100000,notes:['[消耗气态奇迹],[全原初模块100x产出(必须安装在同一主机)]']},
        ...
        { id: 'primordial_myriad_ascension_tier_1', type: 'primordial_myriad_ascension_tier_1',circuit:1, itemInputs: ['gtceu:eternity_nanoswarm','gtceu:cosmic_nanoswarm','gtladditions:strange_annihilation_fuel_rod','gtceu:small_magmatter_dust'], inputFluids: ['gtceu:miracle 100','gtceu:eternity 50','gtceu:infinity 50','gtceu:primordialmatter 20'], itemOutputs: ['4x dishanhai:wl_board_max'], EUt: MAX, duration: 100000, conditions: ["4x dishanhai:wzyh"],notes:'消耗液态奇迹，全原初模块1000x产出(必须安装在同一主机)' },
