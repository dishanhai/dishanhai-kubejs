...
// ========== 通用配方批处理 ==========
    const universalRecipes = [
        ...
        { id: 'chemical_reactor_polyethylene_oxygen', type: 'chemical_reactor', itemInputs: ['2x gtceu:carbon_dust'], inputFluids: ['minecraft:water 2000'], outputFluids: ['gtceu:oxygen 1500', 'gtceu:polyethylene 1500'], EUt: lv, duration: 20, notConsumable: 'dishanhai:wzcz1',circuit:3,notes:'3号电路执行，槽位溢出放不下' },
        ...
        { id: 'sulfuric_acid', type: 'chemical_reactor', itemInputs: ['gtceu:sulfur_dust'], inputFluids: ['minecraft:water 1000'], outputFluids: ['gtceu:sulfuric_acid 1000'], notConsumable: 'dishanhai:wzcz1', EUt: lv, duration: 20,circuit:2,notes:'2号电路执行，槽位溢出放不下' },
        ...
        {id:'chemical_reactor_salt_water',type:'chemical_reactor',circuit:1,inputFluids: ['minecraft:water 1000'], outputFluids: ['gtceu:salt_water 1000'], notConsumable: 'dishanhai:wzcz1', EUt: lv, duration: 20 },
...
//gt_shanhai模组配方批处理
    let myRecipes = [
        // ===== ULV 级 (EUt: ulv) =====
        { id: 'zero_point_conversion_energy_ulv', type: 'zero_point_conversion', notConsumable: ['gtceu:lv_electric_pump', 'gtlcore:primitive_fluid_regulator'], inputFluids: ['minecraft:water 3000'], outputFluids: ['dishanhai:zero_point_energy 100'], EUt: ulv, duration: 20 },
        { id: 'molecular_deconstruction_glass', type: 'molecular_deconstruction', itemInputs: ['minecraft:sand'], outputFluids: ['gtceu:glass 144'], EUt: ulv, duration: 20,notes:"你问我为什么写这个配方，看看永恒熔炼炉呢" },
        {id: "make_world_fragments_10",type: "fragment_world_collection",itemInputs: ["gtlcore:world_fragments_overworld",'4x gtceu:steel_block'],itemOutputs: ["gtlcore:world_fragments_reactor"],notConsumable: ["kubejs:reactor_core"],chancedOutput: [["gtlcore:miracle_crystal","1","0"]],EUt: 8,duration: 200},
        ...
        { id: 'primordial_matter_recombination_wl_board_ulv', type: 'primordial_matter_recombination',circuit:1, itemInputs: ['64x dishanhai:first_light', '4x #gtceu:circuits/ulv'], inputFluids: ['dishanhai:light 2000', 'dishanhai:matter_fluid_entry 2000'], itemOutputs: ['4x dishanhai:wl_board_ulv'], EUt: ulv, duration: 20 },
        ...
        // ===== LV 级 (EUt: 32) =====
        { id:'zero_point_conversion_energy_lv', type: 'zero_point_conversion', notConsumable: ['gtceu:lv_electric_pump', 'gtceu:lv_fluid_regulator'], inputFluids: ['minecraft:water 3000'], outputFluids: ['dishanhai:zero_point_energy 500'], EUt: lv, duration: 20 },
        ...
        // ===== MV 级 (EUt: 128) =====
        { id: 'zero_point_conversion_energy_mv', type: 'zero_point_conversion', notConsumable: ['gtceu:mv_electric_pump', 'gtceu:mv_fluid_regulator'], inputFluids: ['minecraft:water 3000'], outputFluids: ['dishanhai:zero_point_energy 1000'], EUt: mv, duration: 20 },
        ...
        // ===== HV 级 (EUt: 512) =====
        { id:'zero_point_conversion_energy_hv', type: 'zero_point_conversion', notConsumable: ['gtceu:hv_electric_pump', 'gtceu:hv_fluid_regulator'], inputFluids: ['minecraft:water 3000'], outputFluids: ['dishanhai:zero_point_energy 2000'], EUt: hv, duration: 20 },
        { id:"casing_zero_photon",type:"primordial_matter_recombination",itemInputs:['4x gtceu:hv_machine_casing','2x gtceu:hv_machine_hull'],inputFluids: ['dishanhai:zero_point_energy 1000'], itemOutputs: ['1x gt_shanhai:casing_zero_photon'], EUt: hv, duration: 20},
        ...
        { id:'zero_point_conversion_energy_ev', type: 'zero_point_conversion', notConsumable: ['gtceu:ev_electric_pump', 'gtceu:ev_fluid_regulator'], inputFluids: ['minecraft:water 3000'], outputFluids: ['dishanhai:zero_point_energy 4000'], EUt: ev, duration: 20 },
        ...
        // ===== IV 级 (EUt: 8192) =====
        { id:'zero_point_conversion_energy_iv', type: 'zero_point_conversion', notConsumable: ['gtceu:iv_electric_pump', 'gtceu:iv_fluid_regulator'], inputFluids: ['minecraft:water 3000'], outputFluids: ['dishanhai:zero_point_energy 6000'], EUt: iv, duration: 20 },
        ...
        { id: 'primordial_energy_absorption_iv', type: 'primordial_energy_absorption',circuit:3,notConsumable:['dishanhai:dark_energy_multiplier'], inputFluids: ['minecraft:water 3000'], outputFluids: ['dishanhai:zero_point_energy 10000'], EUt: iv, duration: 20, conditions: ['16x dishanhai:wzax'],notes:'此配方需要1个暗能量倍增器作为不消耗物品'},
        ...
        { id: 'incubator_stem_cells', type: 'incubator', itemInputs: ['kubejs:glacio_spirit', 'gtceu:osmiridium_dust'], inputFluids: ['gtceu:sterilized_growth_medium','gtceu:bacteria'], itemOutputs: ['32x gtceu:stem_cells'],outputFluids: ['gtceu:bacterial_sludge 500'], EUt: luv, duration: 200 },
        ...
        { id:'coin_forge_osmium_coin_source', type: 'coin_forge', notConsumable: ["gtceu:credit_casting_mold"], itemInputs: ["9x dishanhai:platinum_coin"], inputFluids: ['gtceu:osmium 36000'], itemOutputs: ["16x dishanhai:osmium_coin"], EUt: luv, duration: 20 },
        // ===== ZPM 级 (EUt: 131072) =====
        ...
        // ===== UV 级 (EUt: uv) =====
        { id: 'primordial_abyssal_refinery', type: 'primordial_matter_recombination', itemInputs: ['128x gtceu:fishing_ground','64x gtceu:digestion_tank','48x gtceu:desulfurizer','48x gtceu:dissolving_tank','32x gtceu:void_fluid_drilling_rig','32x gtceu:wood_distillation','16x gtceu:petrochemical_plant'], inputFluids:['dishanhai:matter_fluid_transition 2000','dishanhai:matter_fluid_zero 10000','dishanhai:matter_fluid_transition 10000'],itemOutputs:['gt_shanhai:primordial_abyssal_refinery'],EUt:uv,duration:200},
        { id: 'primordial_flame_cracking_kiln', type: 'primordial_matter_recombination',itemInputs: ['32x gtceu:coke_oven','32x gtceu:lava_furnace','16x gtceu:large_pyrolyse_oven','8x gtceu:dimensionally_transcendent_dirt_forge','8x gtceu:large_cracker'], inputFluids: ['dishanhai:matter_fluid_transition 2000'], itemOutputs: ['gt_shanhai:primordial_flame_cracking_kiln'],},
        ...
        { id: 'primordial_energy_absorption_uv', type: 'primordial_energy_absorption',circuit:4,notConsumable:['4x dishanhai:dark_energy_multiplier'], inputFluids: ['minecraft:water 10000'], outputFluids: ['dishanhai:zero_point_energy 50000'], EUt: uv, duration: 20, conditions: ['16x dishanhai:wzgl'],notes:'此配方需要4给暗能量倍增器为不消耗物品' },
        ...
        { id: 'primordial_molecular_rift_core', type:'primordial_matter_recombination', itemInputs:['32x gtceu:chemical_distort','16x gtceu:large_chemical_plant','128x dishanhai:primordial_divergence_heart',], itemOutputs:['1x dishanhai:primordial_molecular_rift_core'], EUt:uhv, duration:200},
        ...
        // ===== UEV 级 (EUt: uev) =====
        { id: 'sps_crafting_liquid_starlight', type: 'sps_crafting',circuit:1, inputFluids: ['gtceu:mana 10000'],outputFluids: ['gtceu:liquid_starlight 10000'], EUt: uev, duration: 200},
        ...
        { id: 'primordial_energy_absorption_uev', type: 'primordial_energy_absorption',circuit:5,notConsumable:['64x dishanhai:dark_energy_multiplier'], inputFluids: ['minecraft:water 10000'], outputFluids: ['dishanhai:zero_point_energy 100000'],EUt: uev, duration: 20, conditions: ["32x dishanhai:wzhy"],notes: '此配方需要64个暗能量倍增器为不消耗物品'},
        ...
        // ===== UXV 级 (EUt: uxv) =====
        { id: 'singularity_inversion_primordial_critical_processing_module', type: 'primordial_singularity_inversion', itemInputs:['4x gtladditions:nexus_satellite_factory_mk1','4x gtladditions:nexus_satellite_factory_mk2','4x gtladditions:nexus_satellite_factory_mk3','4x gtladditions:nexus_satellite_factory_mk4','16x dishanhai:dimensional_frame','32x dishanhai:dimensional_matrix'],inputFluids:['dishanhai:primal_chaos 10000','dishanhai:causal_essence 300000'],itemOutputs:['gt_shanhai:primordial_critical_processing_module'], EUt: uxv, duration: 200, conditions: ["4x dishanhai:wzcx"]},
        ...
        { id: 'primordial_myriad_ascension_tier_2', type: 'primordial_myriad_ascension_tier_2', itemInputs: ['kubejs:quantum_chromodynamic_charge','4x kubejs:leptonic_charge','2x kubejs:quantumchromodynamic_protective_plating','2x kubejs:nuclear_star'], inputFluids: ['gtceu:miracle_gas 20','gtceu:liquid_starlight 30','gtceu:uu_matter 20','gtceu:cosmicneutronium 100'],EUt:uxv, duration: 100000,notes:['消耗气态奇迹,全原初模块100x产出(必须安装在同一主机)']},
        ...
        // ===== OpV 级 (EUt: opv) =====
        { id: 'create_data', type: 'world_data_scanner', itemInputs: [ '64x gtceu:data_stick','64x gtceu:magmatter_block','64x gtladditions:primary_soc_wafer'], inputFluids: [ 'kubejs:gelid_cryotheum 8000','gtceu:magnetohydrodynamicallyconstrainedstarmatter 64000'], itemOutputs: [ 'gtladditions:create_data' ], EUt: opv, duration: 200 , notes:['我知道你不会去创造维度'] },
        ...
        { id: 'matter_forging_stabilized_eternity', type: 'matter_forging',circuit:10, itemInputs: ['16x dishanhai:ideal_ashes'], inputFluids: ['dishanhai:matter_fluid_eternal 256000', 'dishanhai:primal_chaos 256000'], outputFluids: ['dishanhai:stabilized_eternity 64000'], EUt: opv, duration: 200, conditions: ["32x dishanhai:wzdf"] },
        ...
        // ===== MAX 级 (EUt: MAX) =====
        { id: 'primordial_sixfold_resource_core',type:'primordial_singularity_inversion',itemInputs:['4x gtceu:door_of_create','16x gtceu:resource_collection','16x gtceu:element_copying','64x gtceu:fission_reactor','128x gtceu:large_gas_collector'],inputFluids:['gtceu:infinity 1000','gtceu:eternity 1000','gtceu:magnetohydrodynamicallyconstrainedstarmatter 1000'],itemOutputs:['gt_shanhai:primordial_sixfold_resource_core'],EUt:max,duration:2000},
        { id: 'qft_timepiece', type: 'qft',circuit:1, notConsumable:['gtceu:spacetime_hex_wire','gtceu:white_dwarf_mtter_nanoswarm','gtceu:black_dwarf_mtter_nanoswarm'],inputFluids: ['gtceu:cosmic_element 100'], itemOutputs: ['kubejs:timepiece'], EUt: max, duration: 20 },
        { id: 'qft_hyper_stable_self_healing_adhesive', type: 'qft',circuit:1, notConsumable:['gtceu:uruium_nanoswarm'],itemInputs:['64x gtceu:activated_carbon_dust','64x gtceu:bismuth_dust'],inputFluids: ['gtceu:oxygen 20000','gtceu:hydrogen 20000','gtceu:cosmic_element 100'], itemOutputs: ['kubejs:hyper_stable_self_healing_adhesive'], EUt: max, duration: 20 },
        { id: 'qft_black_body_naquadria_supersolid', type: 'qft',circuit:2, notConsumable:['gtceu:uruium_nanoswarm'],itemInputs:['64x gtceu:naquadria_dust','64x gtceu:magnesium_dust'],inputFluids: ['gtceu:phosphoric_acid 20000','gtceu:sulfuric_acid 20000','gtceu:cosmic_element 100'], itemOutputs: ['kubejs:black_body_naquadria_supersolid'], EUt: max, duration: 20 },
        { id: 'primordial_myriad_ascension_tier_1', type: 'primordial_myriad_ascension_tier_1', itemInputs:['gtceu:eternity_nanoswarm','gtceu:cosmic_nanoswarm','gtladditions:strange_annihilation_fuel_rod','dishanhai:bhd_hyper_seed'],inputFluids:['gtceu:miracle 100','gtceu:eternity 50','gtceu:infinity 50','gtceu:primordialmatter 20'],EUt: MAX, duration: 100000, conditions: ["4x dishanhai:wzyh"],notes:'消耗液态奇迹，全原初模块1000x产出(必须安装在同一主机)' },
        ...
        { id: 'suprachronal_assembly_line_star_gate_crystal_slurry_coin', type: 'suprachronal_assembly_line', itemInputs: ['sgjourney:universe_stargate','avaritia:infinity_umbrella','avaritia:infinity_ring','avaritia:neutron_ring'],  itemOutputs: ["sgjourney:pegasus_stargate"], EUt: max*114514, duration: 20 },
...
// 以下配方需要 gt_shanhai 模组注册的配方类型
    ...
    // ── 山海商店终端（独立于提交器，给商店供 AE 网络） ─────
    e.shaped('gt_shanhai:shop_terminal', [
        'B  ',
        'I  ',
        'C  '
    ], {
    ...
    const assemblerRecipes = [
        { id: 'heidonqidian', type:'qft', name: '黑洞奇点组装',circuit:1,notConsumable:'16x gtladditions:forge_of_the_antichrist', itemInputs: ['kubejs:naquadria_charge','64x kubejs:time_dilation_containment_unit','64x kubejs:charged_triplet_neutronium_sphere'], itemOutputs: ['1920x kubejs:contained_reissner_nordstrom_singularity'], EUt:uxv, duration: 20 },
        { id: 'qiyiqid', type:'qft', name: '奇异物质组装', circuit:2,notConsumable:'16x gtladditions:forge_of_the_antichrist',itemInputs: ['15x gtceu:degenerate_rhenium_dust','kubejs:leptonic_charge','kubejs:contained_high_density_protonic_matter'], itemOutputs: ['30x kubejs:contained_exotic_matter'], EUt: UXV, duration: 20 },
        { id: 'gaomiduqidian', type:'qft', name: '高密度物质组装',circuit:3,notConsumable:'16x gtladditions:forge_of_the_antichrist', itemInputs: ['kubejs:leptonic_charge','kubejs:time_dilation_containment_unit','kubejs:charged_triplet_neutronium_sphere'], itemOutputs: ['30x kubejs:contained_high_density_protonic_matter'], EUt: UXV, duration: 20 },
...
// ========== 分子解构配方组 ==========
    ...
    const molecularRecipes = [
        { id: 'ytyh', type: 'molecular_deconstruction', name: '时空粉解构', itemInputs: ['gtceu:spacetime_dust'], outputFluids: ['gtceu:spacetime 144'], EUt: opv, duration: 20 },
        { id: 'ciyues', type: 'molecular_deconstruction', name: '恒星磁流体解构', itemInputs: ['gtceu:magnetohydrodynamicallyconstrainedstarmatter_block'], outputFluids: ['gtceu:magnetohydrodynamicallyconstrainedstarmatter 1296'], EUt:max, duration: 20 },
        { id: 'ytciwuz', type: 'molecular_deconstruction', name: '磁物质解构', itemInputs: ['gtceu:magmatter_dust'], outputFluids: ['gtceu:magmatter 144'], EUt: 2147483647, duration: 20 },
        {id:'magnetohydrodynamicallyconstrainedstarmatter_dust', type: 'molecular_deconstruction', name:'磁流体约束恒星物质解构',itemInputs:['gtceu:magnetohydrodynamicallyconstrainedstarmatter_dust'],outputFluids:['gtceu:magnetohydrodynamicallyconstrainedstarmatter 144'],EUt:max, duration: 20}
    ];
    ...
    const compressorRecipes = [
        { id: 'tiny_magmatter_dust', name: '磁物质粉压缩1', itemInputs: ['9x gtceu:tiny_magmatter_dust'], itemOutputs: ['gtceu:small_magmatter_dust'], EUt: 2147483, duration: 20 },
        { id: 'magmatter_dust', name: '磁物质粉压缩2', itemInputs: ['9x gtceu:small_magmatter_dust'], itemOutputs: ['gtceu:magmatter_dust'], EUt: 21474836, duration: 20 }
    ];
...
//==============  通用配方 =================(wx,wuxian,♾️,wx)
    ...
    const dishanhairecipes = [
        {
            id: 'time_reversal_protocol_cosmos_plus',type: 'cosmos_simulation',notConsumable: ['dishanhai:time_reversal_protocol'],itemOutputs:global.cosmos_simulation_output_items,itemOutputs:global.cosmos_simulation_output_items_hxsp,inputFluids: ['minecraft:water 131002'],duration: 1200,notes:'配方还需要水作为输入流体'
        ...
        {id: 'cosmos_simulation_hxsp',type: 'cosmos_simulation',itemInputs:['16x dishanhai:hxsp'],itemOutputs:global.cosmos_simulation_output_items_hxsp,inputFluids: ['gtceu:raw_star_matter_plasma 102400'],duration: 1200,notes:"配方还需要原始恒星混合物等离子体作为流体输入"
        }, //恒星碎片鸿蒙
        {
...
["11520x gtlcore:qft_coil", "10927x gtlcore:dimensionally_transcendent_casing", "6281x gtlcore:manipulator", "864x gtladditions:quantum_glass", "841x kubejs:dimensional_bridge_casing", "216x gtlcore:spacetimecontinuumripper", "1x gtladditions:apocalyptic_torsion_quantum_matrix"]
...
*/
    ...
    try {
        ...
        info('🎨 找到 ' + gtceuFluidList.length + ' 种 gtceu 流体');
        ...
        gtr.assembler(gtceuFluidRecipeId)
            .circuit(1)
            .itemInputs('minecraft:dandelion')
            .itemOutputs(DShanhaiSDA.create('超级磁盘阵列')
                .infinityOutputs(gtceuFluidList)
                .lore([
                    '§7包含所有gtceu流体的无限元件包',
                    '§7流体种类: §e' + gtceuFluidList.length + '§7 种',
                    '§7每个流体存储在无限元件包中',
                    '§8山海私货 v2.7'
                ])
                .build())
    ...
    */
    ...
    try {
        ...
        if (!plasmaFluidList || plasmaFluidList.length === 0) {
            throw new Error('未找到plasma流体');
        }
        info('🎨 找到 ' + plasmaFluidList.length + ' 种plasma流体');
        ...
        gtr.assembler(plasmaFluidRecipeId)
            .circuit(1)
            .itemInputs('minecraft:dandelion')
            .itemOutputs(DShanhaiSDA.create('无限油元件包')
                .infinityOutputs(plasmaFluidList)
                .lore([
                    '§7包含所有油的无限元件包',
                    '§7物品种类: §e' + plasmaFluidList.length + '§7 种',
                    '§7每个物品存储在无限元件包中',
                    '§8山海私货 v2.7'
                ])
                .build())
        ...
        info('✅ 无限plasma流体元件包配方已生成');
    } catch(err) {
        error('❌ 无限plasma流体元件包配方生成失败: ' + err.message);
