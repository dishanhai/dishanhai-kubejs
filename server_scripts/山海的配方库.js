...
const universalRecipes = [
    ...
    { id: 'infinite_coin_mint',    type: 'coin_forge', itemInputs: ['64x avaritia:infinity'],    itemOutputs: ['32x dishanhai:infinite_coin'],    EUt: hv, duration: 200 },
...
let myRecipes = [
  ...
  { id: 'suprachronal_assembly_line_dimensional_frame', type: 'primordial_matter_recombination',
...
console.log(`🗓️ [山海的big私货] ♾️级物品配方添加完毕 成功:${dishanhaiSucc} | 失败:${dishanhaifail} | 耗时:${dishanhai_timer_end}ms`)
    ...
    Item.of('ae2:portable_item_cell_256k', '{amts:[L;1L,1L,1L,1L,1L,1L,1L,1L,1L,1L,1L,1L,1L],ic:13L,internalCurrentPower:20000.0d,keys:[{"#c":"ae2:i",id:"expatternprovider:infinity_cell",tag:{record:{"#c":"ae2:i",id:"kubejs:hypercube"}}},{"#c":"ae2:i",id:"expatternprovider:infinity_cell",tag:{record:{"#c":"ae2:f",id:"gtceu:chaos"}}},{"#c":"ae2:i",id:"expatternprovider:infinity_cell",tag:{record:{"#c":"ae2:f",id:"gtceu:magmatter"}}},{"#c":"ae2:i",id:"expatternprovider:infinity_cell",tag:{record:{"#c":"ae2:i",id:"gtladditions:astral_array"}}},{"#c":"ae2:i",id:"expatternprovider:infinity_cell",tag:{record:{"#c":"ae2:f",id:"gtceu:eternity"}}},{"#c":"ae2:i",id:"expatternprovider:infinity_cell",tag:{record:{"#c":"ae2:i",id:"disksavior:quantum_chromodynamic_charge_super"}}},{"#c":"ae2:i",id:"expatternprovider:infinity_cell",tag:{record:{"#c":"ae2:f",id:"gtceu:white_dwarf_mtter"}}},{"#c":"ae2:i",id:"expatternprovider:infinity_cell",tag:{record:{"#c":"ae2:i",id:"gtladditions:black_hole_seed"}}},{"#c":"ae2:i",id:"expatternprovider:infinity_cell",tag:{record:{"#c":"ae2:f",id:"gtceu:magnetohydrodynamicallyconstrainedstarmatter"}}},{"#c":"ae2:i",id:"expatternprovider:infinity_cell",tag:{record:{"#c":"ae2:i",id:"avaritia:infinity"}}},{"#c":"ae2:i",id:"expatternprovider:infinity_cell",tag:{record:{"#c":"ae2:i",id:"kubejs:infinity_antimatter_fuel_rod"}}},{"#c":"ae2:i",id:"expatternprovider:infinity_cell",tag:{record:{"#c":"ae2:i",id:"kubejs:annihilation_constrainer"}}},{"#c":"ae2:i",id:"expatternprovider:infinity_cell",tag:{record:{"#c":"ae2:f",id:"gtceu:black_dwarf_mtter"}}}]}'),
