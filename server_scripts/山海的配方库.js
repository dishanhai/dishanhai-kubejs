...
//gt_shanhai模组配方批处理
    let myRecipes = [
        ...
        { id: 'primordial_energy_absorption_uev', type: 'primordial_energy_absorption',circuit:5,notConsumable:['4x dishanhai:dark_energy_multiplier'], inputFluids: ['minecraft:water 10000'], outputFluids: ['dishanhai:zero_point_energy 100000'],EUt: uev, duration: 20, conditions: ["32x dishanhai:wzhy"],notes: '此配方需要4个暗能量倍增器为不消耗物品'},
